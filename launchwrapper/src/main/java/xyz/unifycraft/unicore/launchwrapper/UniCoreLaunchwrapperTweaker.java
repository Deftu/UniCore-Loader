...
public class UniCoreLaunchwrapperTweaker implements ITweaker {
    ...
    public void acceptOptions(List<String> args, File gameDir, File assetsDir, String profile) {
        uniCoreLoader = new UniCoreLoader(ForgeVersion.mcVersion, "forge");
    }
...
//$$         uniCoreLoader.initialize(FabricLoaderImpl.INSTANCE.getGameProvider().getNormalizedGameVersion(), "fabric");
//$$     }
//$$
//$$     public static UniCoreLoaderBase getUniCoreLoader() {
//$$        return uniCoreLoader;
